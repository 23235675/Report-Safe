...
.filter-chip { font-size:12px; font-weight:500; padding:4px 10px; background:#fff; border:1px solid #e9e9ec; color:#555; cursor:pointer; font-family:inherit; border-radius:999px; }
...
.cyber-queue-item { background:#fff; border:1px solid #d9dbe0; padding:0; overflow:hidden; cursor:pointer; border-radius:10px; box-shadow:0 1px 2px rgba(0,0,0,0.03); }
